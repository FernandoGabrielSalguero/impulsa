  ...
  <div class="im-aplicacion" data-menu-colapsado="false">
    <aside class="im-menu-lateral" id="menu-lateral" aria-label="Navegacion principal">
      ...
      <nav class="im-navegacion">
        ...
        <a class="im-nav-item activo" href="/impulsa_emprende/controller/emprendedor/EmprendedorMarketingController.php"><span class="material-symbols-rounded" aria-hidden="true">campaign</span><span class="im-nav-item__texto">Marketing</span></a>
        ...
        <a class="im-nav-item" href="/impulsa_emprende/controller/emprendedor/EmprendedorBlogController.php"><span class="material-symbols-rounded" aria-hidden="true">article</span><span class="im-nav-item__texto">Blog</span></a>
