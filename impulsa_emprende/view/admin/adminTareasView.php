...
<head>
  ...
  <style>
    ...
    .im-tarea-modal { width: min(560px, calc(100vw - 2rem)); }
    .im-tarea-modal form { display: contents; }
    .im-tarea-accion-eliminar { color: #ba1a1a; }
    .im-tarea-sheet__meta { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: .75rem; margin-bottom: 1rem; }
    .im-tarea-sheet__meta article { padding: .85rem; border: 1px solid var(--im-color-borde); border-radius: var(--im-radio-chico); background: var(--im-color-superficie); }
    .im-tarea-sheet__meta span { display: block; color: var(--im-color-texto-suave); font-size: .8rem; }
    .im-tarea-sheet__meta strong { display: block; margin-top: .2rem; }
    .im-tarea-sheet__form { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: .9rem; }
    .im-tarea-sheet__form .im-campo--ancho { grid-column: 1 / -1; }
    .im-tabla-tareas__acciones { overflow: visible; position: relative; }
    .im-menu-tabla[data-im-menu].abierto { z-index: 120; }
    .im-menu-tabla[data-im-menu] > .im-menu-tabla__panel { z-index: 130; }
    @media (max-width: 760px) {
      .im-tarea-sheet__form,
      .im-tarea-sheet__meta { grid-template-columns: 1fr; }
    }
  </style>
</head>
<body>
        ...
        <section class="im-seccion-documento activa" id="tareas">
          <div class="im-encabezado-seccion">
            <div>
              ...
              <p>Administra la tabla `admin_tareas` con altas, edicion y eliminacion.</p>
            </div>
            <div class="im-barra-superior__acciones">
