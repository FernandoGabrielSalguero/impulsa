  ...
  <div class="im-aplicacion" data-menu-colapsado="false">
    <aside class="im-menu-lateral" id="menu-lateral" aria-label="Navegacion principal">
      ...
      <nav class="im-navegacion">
        ...
        <a class="im-nav-item" href="/impulsa_emprende/controller/client/ClienteMarketingController.php"><span class="material-symbols-rounded" aria-hidden="true">campaign</span><span class="im-nav-item__texto">Marketing</span></a>
        ...
        <a class="im-nav-item activo" href="#api-product-builder" data-seccion="api-product-builder"><span class="material-symbols-rounded" aria-hidden="true">inventory_2</span><span class="im-nav-item__texto">Productos</span></a>
      </nav>
    </aside>
