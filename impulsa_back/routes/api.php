...
Route::prefix('v1')->group(function (): void {
    ...
    Route::middleware(['auth:sanctum', 'role:impulsa_administrador'])
        ...
        ->group(function (): void {
            ...
            Route::get('users/{userId}/finanzas/settings', [AdminFinanzasController::class, 'settings']);
            Route::get('users/{userId}/finanzas/categories', [AdminFinanzasController::class, 'categories']);
            Route::get('users/{userId}/finanzas/movements', [AdminFinanzasController::class, 'movements']);
            Route::get('users/{userId}/finanzas/fixed-costs', [AdminFinanzasController::class, 'fixedCosts']);
            Route::get('users/{userId}/finanzas/pricing-items', [AdminFinanzasController::class, 'pricingItems']);
            Route::post('users/{userId}/finanzas/pricing/preview', [AdminFinanzasController::class, 'pricingPreview']);
            Route::post('users/{userId}/finanzas/break-even/preview', [AdminFinanzasController::class, 'breakEvenPreview']);
            Route::get('users/{userId}/finanzas/product-references', [AdminFinanzasController::class, 'productReferences']);
            Route::get('users/{userId}/finanzas/projection/baseline', [AdminFinanzasController::class, 'projectionBaseline']);
            Route::post('users/{userId}/finanzas/projection/preview', [AdminFinanzasController::class, 'projectionPreview']);
            Route::get('users/{userId}/finanzas/projections', [AdminFinanzasController::class, 'projections']);
            Route::post('users/{userId}/finanzas/scenarios/preview', [AdminFinanzasController::class, 'scenarioPreview']);
            Route::post('users/{userId}/finanzas/scenarios/compare', [AdminFinanzasController::class, 'compareScenarios']);
            Route::get('users/{userId}/finanzas/scenarios', [AdminFinanzasController::class, 'scenarios']);
