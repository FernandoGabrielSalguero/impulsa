...
class ApiIntegrationController extends Controller
{
    ...
    public function options(): JsonResponse
    {
        ...
        return response()->json([
            ...
            'endpoints' => [
                ['key' => 'sdk', 'label' => 'SDK único (impulsa.js)', 'path' => '/api/v1/public/impulsa.js'],
                ['key' => 'bootstrap', 'label' => 'Bootstrap / capacidades', 'path' => '/api/v1/public/bootstrap'],
                ['key' => 'blog', 'label' => 'Blog', 'path' => '/api/v1/public/blog'],
                ['key' => 'products', 'label' => 'Productos', 'path' => '/api/v1/public/products'],
                ['key' => 'page_visit', 'label' => 'Registro de visita', 'path' => '/api/v1/public/page-visit'],
                ['key' => 'content_view', 'label' => 'Vista de contenido', 'path' => '/api/v1/public/content-view'],
                ['key' => 'chatbot', 'label' => 'Chatbot', 'path' => '/api/v1/public/chatbot'],
                ['key' => 'chatbot_events', 'label' => 'Eventos chatbot', 'path' => '/api/v1/public/chatbot/events'],
                ['key' => 'contact', 'label' => 'Formulario de contacto', 'path' => '/api/v1/public/contact-submissions'],
