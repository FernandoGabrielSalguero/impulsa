...
class UserDeletionService
{
    public function delete(UserAuth $user): void
    {
        DB::transaction(function () use ($user): void {
            ...
            $this->updateToNull('project_deliverables', 'assigned_user_id', $userId);
    ...
    private function deleteProjects(array $projectIds): void
    {
        ...
        $this->deleteByIds('project_deliverable_comments', 'deliverable_id', $deliverableIds);
        $this->deleteByIds('project_deliverable_comments', 'project_id', $projectIds);
