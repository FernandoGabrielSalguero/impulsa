...
class SubscriptionMonthlyNoticeMail extends ImpulsaMailable
{
    ...
    {
        return MailTemplate::SubscriptionMonthlyNotice;
    }
    ...
    {
        return 'Aviso de suscripción mensual — ' . $this->integration->project_name;
    }

    public function htmlView(): string
    {
        return 'mail.subscription-monthly-notice';
    }

    public function textView(): string
    {
        return 'mail.subscription-monthly-notice-text';
    }
